...
from prometheus_client import Counter, Histogram, Gauge, Enum, Info, generate_latest
from prometheus_client.core import REGISTRY

# Root endpoint metrics
ROOT_REQUESTS = Counter("root_requests_total", "Total requests to root endpoint")

ROOT_REQUEST_DURATION = Histogram(
    "root_request_duration_seconds", "Root endpoint request duration"
)
...
CURRENT_TEMPERATURE = Gauge(
    "current_temperature_celsius", "Current average temperature in Berlin"
)
...
# Version metrics
VERSION_INFO = Info("app_version", "Application version information")
